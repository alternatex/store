...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		java.lang.String __temp_stmt50 = null;
		{
			...
			switch (__temp_hash53)
			{
				...
				{
					if (( (( ( __temp_hash53 == -672261858 ) && __temp_svar51.equals("Integer") )) || __temp_svar51.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar51.equals("Object")) 
					{
						__temp_executeDef52 = false;
						__temp_stmt50 = "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash53 == 2052876273 ) && __temp_svar51.equals("Double") )) || __temp_svar51.equals("double") )) 
					{
						__temp_executeDef52 = false;
						__temp_stmt50 = "Float";
					}
