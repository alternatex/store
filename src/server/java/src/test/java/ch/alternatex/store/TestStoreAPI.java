...
public class TestStoreAPI {
  ...
  static final String API_DEVICE_AUTHORIZE = "/{app}/stores/{store}/devices/{device}/";
  static final String API_DEVICE_REVOKE = "/{app}/stores/{store}/devices/{device}/";
